...
task.audio_file_path_absolute = os.path.abspath(os.path.join('data', 'cadiz_ch_1_audio_small.mp3'))
task.text_file_path_absolute = os.path.abspath(os.path.join('data', 'cadiz_ch_1_text_small.txt'))
#task.text_file_path_absolute = os.path.abspath(os.path.join('data', 'cadiz_ch_1_text_small_exp.txt'))
